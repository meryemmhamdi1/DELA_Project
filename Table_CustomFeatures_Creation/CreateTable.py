...
def ExportAsCSV(DataSet):
    ...
    for ProblemID in DataSet.keys():
        ...
        for UserID in DataSet[ProblemID].keys():
            ...
            for SubmissionNumber in DataSet[ProblemID][UserID].keys():
                ...
                # Build basic row
                Row = [ProblemID, UserID, SubmissionNumber, TimeStamp, TimeSinceLast, Grade, GradeDiff, NVideoEvents,
                       NForumEvents]
    ...
    ColumnNames = ['ProblemID', 'UserID', 'SubmissionNumber', 'TimeStamp', 'TimeSinceLast', 'Grade', 'GradeDiff',
