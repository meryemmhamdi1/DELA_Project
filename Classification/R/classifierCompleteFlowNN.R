...
dll = read.csv('/media/diskD/EPFL/Fall 2016/DELA/DELA_Project/Classification/Predictions.csv', stringsAsFactors = F)

labels <- factor(dll$Predictions)
ROC_curve_train_nn = roc(dll$Improved, labels); auc(ROC_curve_train_nn)
